...
{
	public class HtmlDocumentReplacerEditor : ListReplaceEditor
	{
		protected override List<ReplaceParameter> GetParameters()
		{
			return Data.ReplaceTagIds;
		}

		public HtmlDocumentReplacerEditor(DataGridView gridView) : base(gridView) { }

		public new HtmlDocumentReplacer Data
		{
			get { return (HtmlDocumentReplacer)base.Data; }
		}
	}
}
