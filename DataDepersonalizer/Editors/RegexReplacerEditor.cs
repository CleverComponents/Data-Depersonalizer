...
{
	public class RegexReplacerEditor : ListReplaceEditor
	{
		protected override List<ReplaceParameter> GetParameters()
		{
			return Data.RegexReplacePatterns;
		}

		public RegexReplacerEditor(DataGridView gridView) : base(gridView) { }

		public new RegexReplacer Data
		{
			get { return (RegexReplacer)base.Data; }
		}
	}
}
