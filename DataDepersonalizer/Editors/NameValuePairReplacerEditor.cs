...
{
	public class NameValuePairReplacerEditor : ListReplaceEditor
	{
		protected override List<ReplaceParameter> GetParameters()
		{
			return Data.ReplacePairs;
		}

		public NameValuePairReplacerEditor(DataGridView gridView) : base(gridView) { }

		public new NameValuePairReplacer Data
		{
			get { return (NameValuePairReplacer)base.Data; }
		}
	}
}
